        ...
        if (f2==1):     #open from txt
            ...
            while(True):
                ...
                if(f2==1):
                    ...
                    print("\nenter name\n")
                    name=input()
                    print("enter mode of image")
                    mode_im=input()
                    file=open(name,"rb")
                    A=np.load(file)
                    file.close()
                    img=Image.fromarray(A, mode=mode_im)
                    return img
...
def arithmetic():                #Arithmetic coding
...
while(True):        #main cycle    
    ...
    if (f==1):      #RLE
        ...
        print("\nchoose Image:\n1 - white and black\n2 - gray\n3 - color\n4 - other") #choose image
        im = ask(1,4)
        
        if (im==1):
            filename="white_and_black.jpg"
        elif(im==2):
